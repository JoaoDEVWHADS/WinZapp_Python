...
def test_i18n_audit_covers_setup_and_save_filters():
    conversations = _source("client/ui/conversations.py")
    api_setup = _source("client/ui/dialogs/api_setup.py")
    for key in (
        "file_filter_audio",
        "file_filter_images",
        "file_filter_videos",
    ...
    for key in (
        "api_setup_downloading",
        "api_setup_extracting",
        "api_setup_preparing_folder",
        "api_setup_npm_install",
        "api_setup_db_generate",
        "api_setup_building",
    ):
        assert key in api_setup
