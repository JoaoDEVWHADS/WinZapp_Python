...
class _Stub:
    ...
    def __init__(self, current_audio_id=None, is_playing=False, tempo_ctrl=None, stream_raises=False):
        self._current_audio_id = current_audio_id
        self._audio_stream = _FakeStreamCtrl(raise_on_play=stream_raises) if current_audio_id else None
...
class TestPauseAndResume:
    ...
    def test_a_failed_resume_stops_audio_instead_of_crashing(self):
